  ...
  var ITEMS = [
    {
      id: 'daf',
      name: 'דף גמרא',
      desc: 'דף ב, מסכת ברכות. דף העזר הרשמי של ההרפתקה. מריח כמו בית מדרש ישן.',
      icon: DAF_ICON
    },
    {
      id: 'starproof',
    ...
    try {
      ...
      if (stage) {
        var card = makeEl('div', 'endcard',
          ...
          '<p class="endcard-sub">דף ב — סיימת אותו באמת. 🎉</p>' +
          '<ul class="credits">' +
          ...
          '<li>בקרוב: הדף הבא — הכינור של דוד המלך כבר מתכוונן לחצות</li>' +
          '</ul>' +
